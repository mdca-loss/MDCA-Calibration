...
This is the official PyTorch implementation for the paper: "A Stitch in Time Saves Nine: A Train-Time Regularizing Loss for Improved Neural Network Calibration". Paper is published at CVPR'22 and was an ORAL Presentation.
## Abstract
...
Trivia: The title " A stitch in time saves Nine" suggests we output well-calibrated models via a joint optimization of calibration loss alongside the any classification loss thereby outputting well-calibrated models in one go rather than in a post-hoc fashion.
